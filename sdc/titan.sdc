...
# Sun Dec  3 15:30:57 2023
###############################################################################
current_design titan
###############################################################################
# Timing Constraints
###############################################################################
create_clock -name clock -period 24.0000 
set_clock_uncertainty 0.2500 clock
set_input_delay 4.8000 -clock [get_clocks {clock}] -add_delay [get_ports {spi_clock_i}]
set_input_delay 4.8000 -clock [get_clocks {clock}] -add_delay [get_ports {spi_cs_i}]
set_input_delay 4.8000 -clock [get_clocks {clock}] -add_delay [get_ports {spi_pico_i}]
set_input_delay 4.8000 -clock [get_clocks {clock}] -add_delay [get_ports {sys_clock_i}]
set_output_delay 4.8000 -clock [get_clocks {clock}] -add_delay [get_ports {spi_poci_o}]
###############################################################################
# Environment
###############################################################################
